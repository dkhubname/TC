...
import io.swagger.client.model.ChangeStatus;
import io.swagger.client.model.Changes;
import io.swagger.client.model.Commiter;
import io.swagger.client.model.FileChanges;
import io.swagger.client.model.Items;
import io.swagger.client.model.Properties;
import io.swagger.client.model.SnapshotDependencyLink;
...
public class Change {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, version, internalVersion, username, date, registrationDate, personal, href, webUrl, comment, user, type, snapshotDependencyLink, files, vcsRootInstance, parentChanges, parentRevisions, attributes, storesProjectSettings, status, commiter, locator, canEditComment);
  }
