...
import io.swagger.client.model.TestCounters;
import io.swagger.client.model.TestOccurrence;
...
public class TestOccurrences {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(count, href, nextHref, prevHref, testOccurrence, testCounters, newFailed, failed, passed, ignored, muted);
  }
